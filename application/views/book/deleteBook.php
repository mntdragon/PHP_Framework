      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            ...
            <li><a href="<?php echo base_url('book/show');?>">Show Books</a></li>
            <li><a href="<?php echo site_url('book/addBook');?>">Add Books</a></li>
            <li class="active"><a href="<?php echo site_url('book/deleteBook');?>">Delete Books</a></li>
          </ul>
        </div><!--/.nav-collapse -->
      </div>
    </nav>
<h1 id="welcome">DELETE CUSTOMERS</h1>
<TABLE BORDER ="1">
    <TR>
        <TH>id</TH>
        <TH>Name</TH>
    ...
    foreach($book as $row){
        ...
        echo '<td>';
        echo '<button class="fg-button teal"><a href="'.site_url('Book/removeBook').'/'.$row['id'].'"> Delete </a></button>';
        echo '</td></tr>';
